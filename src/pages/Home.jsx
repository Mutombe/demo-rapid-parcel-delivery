    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      >
        ...
        <div className="overflow-hidden">
          {['RAPID', 'PARCEL', 'DELIVERY.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
...
function RouteTrackingStrip() {
  const routes = ['WESTLEA', 'CBD', 'AVONDALE', 'BORROWDALE', 'MT PLEASANT', 'GREENDALE', 'MSASA', 'WATERFALLS', 'HIGHFIELD'];
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            <div>
              <p className="text-orange-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>What We Move</p>
    ...
    <section ref={containerRef} className="bg-navy-950 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 mb-12 sm:mb-16">
        ...
        >
          <div>
            <div className="w-12 h-[3px] bg-orange-500 mb-6" />
            <p className="text-orange-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Our Fleet</p>
            <h2 className="font-heading text-white leading-[0.92]" style={{ fontSize: 'clamp(2rem, 5vw, 4rem)' }}>
              Built to <span className="text-orange-500">Deliver</span>
            </h2>
          </div>
          <Link
            to="/projects"
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'Under-1-Hour CBD', desc: 'Guaranteed sub-60-minute delivery anywhere in Harare CBD during business hours.' },
    { title: 'Photo Proof', desc: 'Every delivery photographed and timestamped. Sent directly to your phone.' },
    { title: 'Motorbike + Van', desc: 'Right-sized vehicles for every job. Documents to pallets, we handle it all.' },
    { title: 'Flat Rates', desc: 'Zone-based flat-rate pricing. No surge pricing, no surprises.' },
  ];
