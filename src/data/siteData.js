...
const siteData = {
  business: {
    name: "Rapid Parcel Delivery",
    legalName: "Rapid Parcel Delivery",
    tagline: "Delivering Excellence Across Zimbabwe",
    description: "Founded with a belief that Zimbabwe deserves world-class logistics, Rapid Parcel Delivery has grown from a single delivery van into one of Harare's most trusted courier and freight companies.",
    phone: "+263 73 490 9384",
    phoneRaw: "+263734909384",
    whatsappNumber: "263734909384",
    email: "info@rapidparceldelivery.co.zw",
    address: "181 Westlea, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 5,
    ratingRounded: 5,
    ...
    cookieConsentKey: "rapid-parcel-delivery-cookie-consent",
    socialLinks: { facebook: "", instagram: "#", linkedin: "#" },
  },

  navbar: { logoImage: null, logoLine1: "Rapid", logoLine2: "Parcel Delivery" },
  ...
  homeTestimonials: [
    { text: "We switched to Rapid Parcel Delivery six months ago and our delivery complaints dropped to almost zero. The real-time tracking gives our customers confidence.", name: "Tendai Moyo", role: "E-Commerce Director", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    { text: "Same-day delivery in Harare that actually works. Rapid Parcel Delivery has been a game-changer for our pharmacy business.", name: "Rudo Nhemachena", role: "Pharmacy Owner", rating: 5, avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80" },
    { text: "Reliable, professional, and always on time. Rapid Parcel Delivery handles all our corporate logistics and we could not be happier.", name: "James Karanga", role: "Operations Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&q=80" },
  ...
  about: {
    ...
    story: [
      "Founded with a belief that Zimbabwe deserves world-class logistics, Rapid Parcel Delivery has grown from a single delivery van into one of Harare's most trusted courier and freight companies.",
  ...
  reviews: {
    ...
    items: [
      { text: "We switched to Rapid Parcel Delivery six months ago and our delivery complaints dropped to almost zero. The real-time tracking gives our customers confidence.", name: "Tendai Moyo", role: "E-Commerce Director", rating: 5 },
      { text: "Same-day delivery in Harare that actually works. Rapid Parcel Delivery has been a game-changer for our pharmacy business.", name: "Rudo Nhemachena", role: "Pharmacy Owner", rating: 5 },
      { text: "Reliable, professional, and always on time. Rapid Parcel Delivery handles all our corporate logistics and we could not be happier.", name: "James Karanga", role: "Operations Manager", rating: 5 },
      ...
      { text: "Outstanding service from start to finish. Rapid Parcel Delivery exceeded all our expectations.", name: "Memory Dube", role: "Satisfied Customer", rating: 5 },
      { text: "Professional, reliable, and great value for money. I recommend Rapid Parcel Delivery to everyone.", name: "Tafadzwa Chikumba", role: "Regular Client", rating: 5 },
      { text: "The team at Rapid Parcel Delivery is knowledgeable and always willing to go the extra mile.", name: "Chenai Manyika", role: "Business Owner", rating: 5 },
      { text: "Consistently excellent service. Rapid Parcel Delivery has been our trusted partner for years.", name: "Patrick Nhamo", role: "Property Manager", rating: 5 },
    ],
  },
  ...
  homeCta: {
    ...
    whatsappText: "Hi Rapid Parcel Delivery! I would like to request a quote.",
